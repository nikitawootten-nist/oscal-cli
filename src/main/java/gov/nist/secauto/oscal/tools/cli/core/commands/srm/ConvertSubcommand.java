...
import gov.nist.secauto.oscal.lib.model.SharedResponsibility;
...
public class ConvertSubcommand
  ...
  public String getDescription() {
    return "Convert the specified OSCAL Shared Responsibility to a different format";
  }

  @Override
  public Class<?> getOscalClass() {
    return SharedResponsibility.class;
  }
}
