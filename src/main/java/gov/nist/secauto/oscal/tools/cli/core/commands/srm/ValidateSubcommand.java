...
public class ValidateSubcommand
  ...
  public String getDescription() {
    return "Check that the specified OSCAL instance is well-formed and valid to the Shared Responsibility model.";
  }
    ...
    retval.add(
        ObjectUtils.requireNonNull(
            XmlUtil.getStreamSource(
                OscalBindingContext.class.getResource("/schema/xml/oscal-shared-responsibility_schema.xsd"))));
  ...
  protected JSONObject getOscalJsonSchema() {
    return JsonSchemaContentValidator.toJsonObject(
        ObjectUtils.requireNonNull(
            OscalBindingContext.class.getResourceAsStream("/schema/json/oscal-shared-responsibility_schema.json")));
  }
}
